 ...
 * </p>
 * <p>
 * There are two styles of MQTT client, this one and {@link org.eclipse.paho.client.mqttv3.IMqttClient}.
 * <ul>
 ...
 * For more details on the blocking client see {@link org.eclipse.paho.client.mqttv3.IMqttClient}</p>
 *
 ...
 *   use the {@link org.eclipse.paho.client.mqttv3.MqttCallback#deliveryComplete(IMqttDeliveryToken)} method which will
...
public interface IMqttAsyncClient {
	 ...
	 * @throws org.eclipse.paho.client.mqttv3.MqttException  for non security related problems
	 ...
	 * It is recommended to call {@link #setCallback(org.eclipse.paho.client.mqttv3.MqttCallback)} prior to
	 ...
	 * be tracked by:
	 * <ul>
	 * <li>Waiting on the returned token {@link org.eclipse.paho.client.mqttv3.IMqttToken#waitForCompletion()} or</li>
	 ...
	 * will be passed to any callback that has been set.
	 * @throws MqttSecurityException  for security related problems
	 * @throws org.eclipse.paho.client.mqttv3.MqttException  for non security related problems including communication errors
	 */
	 ...
	 * will be passed to any callback that has been set.
	 * @throws org.eclipse.paho.client.mqttv3.MqttException for problems encountered while disconnecting
	 ...
	 * Disconnects from the server.
	 * <p>
	 * The client will wait for {@link org.eclipse.paho.client.mqttv3.MqttCallback} methods to
	 ...
	 * <p>This method must not be called from inside {@link org.eclipse.paho.client.mqttv3.MqttCallback} methods.</p>
	 ...
	 * 
	 * @throws org.eclipse.paho.client.mqttv3.MqttException if any unexpected error
	 * @since 0.4.1
	 */
	 ...
	 * @see org.eclipse.paho.client.mqttv3.MqttAsyncClient#MqttAsyncClient(String, String)
	 */
	 ...
	 * @throws org.eclipse.paho.client.mqttv3.MqttException for other errors encountered while publishing the message.
	 * For instance if too many messages are being processed.
	 * @see #publish(String, org.eclipse.paho.client.mqttv3.MqttMessage, Object, IMqttActionListener)
	...
	/**
	 * Publishes a message to a topic on the server.
	 * Takes an {@link org.eclipse.paho.client.mqttv3.MqttMessage} message and delivers it to the server at the
	 ...
	 * be tracked by:
	 * <ul>
	 * <li>Setting an {@link org.eclipse.paho.client.mqttv3.IMqttAsyncClient#setCallback(org.eclipse.paho.client.mqttv3.MqttCallback)} where the
	 * {@link org.eclipse.paho.client.mqttv3.MqttCallback#deliveryComplete(IMqttDeliveryToken)}
	 * method will be called.</li>
	 * <li>Waiting on the returned token {@link org.eclipse.paho.client.mqttv3.MqttToken#waitForCompletion()} or</li>
	 ...
	 * will be passed to callback methods if set.
	 * @throws org.eclipse.paho.client.mqttv3.MqttException if there was an error registering the subscription.
	 */
	 ...
	 * Subscribes to multiple topics, each of which may include wildcards.
 	 * <p>Provides an optimized way to subscribe to multiple topics compared to
	 * subscribing to each one individually.</p>
	 * <p>The {@link #setCallback(org.eclipse.paho.client.mqttv3.MqttCallback)} method
	 ...
	 * be tracked by:
	 * <ul>
	 * <li>Waiting on the supplied token {@link org.eclipse.paho.client.mqttv3.MqttToken#waitForCompletion()} or</li>
	 * <li>Passing in a callback {@link IMqttActionListener} to this method</li>
	 * </ul>
	 * </p>
	 *
	 ...
	 * will be passed to callback methods if set.
	 * @throws org.eclipse.paho.client.mqttv3.MqttException if there was an error unregistering the subscription.
	 */
	 ...
	 * as connect and subscribe can be tracked using the {@link org.eclipse.paho.client.mqttv3.MqttToken} returned from
	 ...
	 * Alternately the {@link org.eclipse.paho.client.mqttv3.MqttCallback#deliveryComplete(IMqttDeliveryToken)}
	 ...
	 * @throws org.eclipse.paho.client.mqttv3.MqttException  if the client is not disconnected.
	 */
