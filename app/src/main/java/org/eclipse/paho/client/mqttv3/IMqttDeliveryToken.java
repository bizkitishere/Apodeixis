 ...
 * {@link org.eclipse.paho.client.mqttv3.IMqttAsyncClient#getPendingDeliveryTokens()}.  The waitForCompletion
 * method can then be used to block until the delivery is complete.
 * <li>A {@link org.eclipse.paho.client.mqttv3.MqttCallback} can be set on the client. Once a message has been
 * delivered the {@link org.eclipse.paho.client.mqttv3.MqttCallback#deliveryComplete(org.eclipse.paho.client.mqttv3.IMqttDeliveryToken)} method will
...
public interface IMqttDeliveryToken extends IMqttToken {
	 ...
	 * @throws org.eclipse.paho.client.mqttv3.MqttException if there was a problem completing retrieving the message
	 */
