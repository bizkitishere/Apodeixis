...
public class MqttException extends Exception {
	...
	/** 
	 * The client is not connected to the server.  The {@link org.eclipse.paho.client.mqttv3.MqttClient#connect()}
	 * or {@link org.eclipse.paho.client.mqttv3.MqttClient#connect(MqttConnectOptions)} method must be called
	 * first.  It is also possible that the connection was lost - see 
	 * {@link org.eclipse.paho.client.mqttv3.MqttClient#setCallback(org.eclipse.paho.client.mqttv3.MqttCallback)} for a way to track lost
	 * connections.  
	 */
	...
	/** 
	 * Thrown when an attempt to call {@link org.eclipse.paho.client.mqttv3.MqttClient#disconnect()} has been
	 * made from within a method on {@link org.eclipse.paho.client.mqttv3.MqttCallback}.  These methods are invoked
