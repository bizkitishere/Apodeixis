 ...
 * of this interface using {@link org.eclipse.paho.client.mqttv3.MqttClient#MqttClient(String, String, org.eclipse.paho.client.mqttv3.MqttClientPersistence)},
 * which the {@link org.eclipse.paho.client.mqttv3.MqttClient} will use to persist QoS 1 and 2 messages.
 * <p>
 * If the methods defined throw the MqttPersistenceException then the state of the data persisted
 * should remain as prior to the method being called. For example, if {@link #put(String, org.eclipse.paho.client.mqttv3.MqttPersistable)}
