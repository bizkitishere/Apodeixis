...
public IMqttToken connectWithResult(MqttConnectOptions options) throws MqttSecurityException, MqttException;
  ...
  public void unsubscribe(String[] topicFilters) throws MqttException;
	 ...
	 * as connect and subscribe can be tracked using the {@link org.eclipse.paho.client.mqttv3.MqttToken} passed to the
	 * operation<p>
	 * @see MqttCallback
	 ...
	 * <ul>
	 * <li>{@link org.eclipse.paho.client.mqttv3.MqttClient#publish(String, MqttMessage)} to publish a message in a blocking manner
